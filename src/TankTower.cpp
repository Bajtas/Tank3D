...
GLuint TankTower::texture;

TankTower::TankTower() : r(1), g(1), b(1)
{
...
void TankTower::loadModel(const char *Path) {
...
TankTower::TankTower(string Path) : r(1), g(1), b(1) {
	TextureHandler::setTexture(texture, Path);
}

void TankTower::setTexture(std::string Path) {
	TextureHandler::setTexture(texture, Path);
}
