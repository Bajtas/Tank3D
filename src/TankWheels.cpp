...
TankWheels::TankWheels() : r(1), g(1), b(1)
{
}
GLuint TankWheels::texture;

void TankWheels::loadModel(const char *Path) {
...
TankWheels::TankWheels(string Path) : r(1), g(1), b(1) {
	TextureHandler::setTexture(this->texture, Path);
}

void TankWheels::setTexture(std::string Path) {
	TextureHandler::setTexture(texture, Path);
}

void TankWheels::draw() {
