...
TankSteeringWheel::TankSteeringWheel() : r(1), g(1), b(1)
{
}
GLuint TankSteeringWheel::texture;

void TankSteeringWheel::loadModel(const char *Path) {
...
TankSteeringWheel::TankSteeringWheel(string Path) : r(1), g(1), b(1) {
	TextureHandler::setTexture(this->texture, Path);
}

void TankSteeringWheel::setTexture(std::string Path) {
	TextureHandler::setTexture(texture, Path);
}

void TankSteeringWheel::draw() {
